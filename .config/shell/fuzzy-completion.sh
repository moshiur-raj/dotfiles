...
export FUZZY_COMPLETION_PATHS=(~/.local/bin $XDG_CONFIG_HOME/bashrc ~/Documents $XDG_CONFIG_HOME/{nvim,zsh,mpv,alacritty,environment.d,mimeapps.list,ipython/profile_default,shell} $XDG_DATA_HOME/applications ~/projects ~/Nextcloud/Notes ~/Templates)
